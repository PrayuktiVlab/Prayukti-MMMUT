...
export default function DAALabDetail({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params);
    const labId = id.startsWith('daa-exp-') ? id : `daa-exp-${id}`;
        ...
        <div className="min-h-screen bg-white text-black font-sans selection:bg-black selection:text-white">
            <header className="bg-white border-b-2 border-black/5 sticky top-0 z-20 backdrop-blur-md bg-white/80">
                <div className="container mx-auto px-4 py-4 flex items-center gap-4">
                    ...
                    <span className="text-sm font-bold uppercase tracking-wider text-gray-400">DAA</span>
                ...
                <div className="lg:col-span-4 space-y-8">
                    <div className="sticky top-24 space-y-8">
                        <div className="bg-blue-50 border-2 border-blue-100 rounded-xl p-8 relative overflow-hidden group">
                            ...
                            <h3 className="font-black text-xl uppercase tracking-tight mb-2 relative z-10 text-blue-900">Ready to Analyze?</h3>
                            <p className="text-sm font-medium text-blue-800/70 mb-8 relative z-10 leading-relaxed">
                                Launch the complexity analyzer to test your algorithm with different input sizes.
                            </p>
                            <Link href={`/dashboard/daa/${labId}/simulation`}>
            ...
            <Chatbot subject="DAA" labTitle={lab.metadata.title} />
            <Footer />
        </div>
    );
}
