...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex h-screen bg-slate-50 overflow-hidden font-sans">
            <React.Suspense fallback={<div className="w-80 bg-slate-900" />}>
                <AdminSidebar isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} handleLogout={handleLogout} />
            </React.Suspense>
            ...
            <main className="flex-1 overflow-hidden flex flex-col relative bg-slate-50/50">
                ...
                <React.Suspense fallback={<div className="p-8">Loading Content...</div>}>
                    {children}
                </React.Suspense>
            </main>
        </div>
...
function AdminSidebar({ isSidebarOpen, setIsSidebarOpen, handleLogout }: any) {
